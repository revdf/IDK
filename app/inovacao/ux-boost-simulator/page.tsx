      ...
      <div className="container mx-auto px-4 lg:px-8">
        <div className="max-w-6xl">
          ...
          <p className="text-slate-600 text-lg">
            escolha a mudanca desejada, descreva a ideia e o simulador projeta impacto em todos os aspectos: conversao, usabilidade, acessibilidade, velocidade, proposicao de valor, navegacao, conteudo, hierarquia visual, responsividade, consistencia e desempenho.
          </p>
        </div>
        ...
        <div className="mt-10 grid gap-8 lg:grid-cols-2">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-slate-900 text-white rounded-3xl p-6 shadow-xl space-y-4">
              <p className="text-sm uppercase tracking-wide text-slate-300">explicacao humana</p>
              <p className="text-lg leading-relaxed">
                {prediction
                  ? prediction.commentary
                  : 'ativamos o modo de previsao. selecione a mudanca e clique em gerar previsao para receber um parecer completo sobre todos os aspectos de ux/ui.'}
              </p>
              <ul className="text-sm text-slate-200 space-y-1 list-disc list-inside">
                <li>indica antes onde investir tempo de design</li>
                <li>evita ciclos longos de teste a/b</li>
                <li>usa dados do idk para prever desempenho em todas as dimensoes</li>
                <li>cobre clareza, navegacao, usabilidade, acessibilidade, conteudo, hierarquia, responsividade, consistencia e desempenho</li>
              </ul>
            </div>
          </div>
        </div>
